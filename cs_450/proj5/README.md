...
the previous project.  Please see the description of that project for the basics, and the
...
ease of portability. The included `hw5.py` includes a reference stop and wait
implementation.
